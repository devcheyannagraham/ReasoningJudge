...
@CrewBase
class Reasoningjudge1():
    """Reasoningjudge1 crew"""
    ...
    @task
    def thinking_task(self) -> Task:
        return Task(
            config=self.tasks_config['thinking_task'], # type: ignore[index]
        )
    ...
    def improve_task(self) -> Task:
        return Task(
            config=self.tasks_config['improve_task'], # type: ignore[index]
        )
    ...
    @crew
    def crew(self) -> Crew:
        """Creates the Reasoningjudge1 crew"""
